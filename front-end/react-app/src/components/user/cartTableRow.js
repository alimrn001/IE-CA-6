                    ...
                    <tr>
                        ...
                        <td>
                            <div class="counter-btn d-flex justify-content-around">
                                <div><button class="counter-btn-item" onClick={() => this.decreaseOrderCount(this.props.updateItemCount, this.props.item.providerID)}>-</button></div>
                                <div><button class="counter-btn-item" >{this.state.orderCount }</button></div>
                                <div><button class="counter-btn-item" onClick={() => this.increaseOrderCount(this.props.item.inStock, this.props.updateItemCount, this.props.item.providerID)}>+</button></div>
                            </div>
                            {/* <div class="counter-btn d-flex justify-content-around">
